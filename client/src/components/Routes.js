...
export default class Routes extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Route exact path="/" render={(props) => <Home {...props} title={this.props.title} body={this.props.body} date={this.props.date} onCommentSubmit={this.props.onCommentSubmit} showPastPost={this.props.showPastPost} keyPress={this.props.keyPress} postId={this.props.postId} getArchivedDate={this.props.getArchivedDate} />} />
